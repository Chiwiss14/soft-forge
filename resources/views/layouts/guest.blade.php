...
<head>
    ...
    <style>
        ...
        .nav-darker { background-color: #090B10; }
        .nav-link-hover { background-color: #1a1b3c; }
    </style>
</head>
<body class="bg-gray-100 text-gray-800">

    {{-- NAVBAR --}}
    <nav class="nav-darker shadow-md">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                <!-- Logo -->
                <div class="flex-shrink-0">
                    <a href="{{ url('/') }}" class="flex items-center space-x-3 text-white" aria-label="SOFT-FORGE home">
                        <img src="/assets/images/projectlogo.png" alt="SOFT-FORGE logo" class="h-28 w-10 object-contain">
                        <span class="font-bold text-lg">SOFT-FORGE</span>
                    </a>
                </div>

                <!-- Desktop Nav Links -->
                <div class="hidden md:flex items-center space-x-4">
                    <a href="{{ url('/') }}" class="text-gray-200 hover:bg-gray-800 hover:text-white px-3 py-2 rounded-md font-medium">Home</a>
                    <a href="{{ url('/services') }}" class="text-gray-200 hover:bg-gray-800 hover:text-white px-3 py-2 rounded-md font-medium">Services</a>
                    <a href="{{ url('/portfolio') }}" class="text-gray-200 hover:bg-gray-800 hover:text-white px-3 py-2 rounded-md font-medium">Portfolio</a>
                    <a href="{{ url('/about-us') }}" class="text-gray-200 hover:bg-gray-800 hover:text-white px-3 py-2 rounded-md font-medium">About Us</a>
                    <a href="{{ url('/careers') }}" class="text-gray-200 hover:bg-gray-800 hover:text-white px-3 py-2 rounded-md font-medium">Careers</a>
                    <a href="{{ url('/contact') }}" class="text-gray-200 hover:bg-gray-800 hover:text-white px-3 py-2 rounded-md font-medium">Contact</a>

                    <!-- Quick Quote -->
                    <a href="#" class="bg-yellow-400 hover:bg-yellow-500 text-black font-bold py-2 px-4 rounded-md transition-colors duration-200">Quick Quote</a>
                </div>

                <!-- Mobile menu toggle could go here if you want -->
            </div>
        </div>
    </nav>

    {{-- HERO SLOT (full-bleed area sits BEFORE the constrained main) --}}
    @isset($hero)
        {!! $hero !!}
    @endisset
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-wrap justify-center gap-6 md:gap-8">
                ...
                <a href="mailto:someone@example.com"
                    ...
                    <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                        <path
                            d="M12 12.713 1.2 5.25A2 2 0 0 1 3.2 3h17.6a2 2 0 0 1 2 2.25L12 12.713Zm0 0L1 5.25V19a2 2 0 0 0 2 2h18a2 2 0 0 0 2-2V5.25L12 12.713Z" />
                    </svg>
                </a>
                <!-- Facebook -->
                <a href="#" target="_blank" class="text-gray-400 hover:text-white transition-colors duration-300">
                    <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                        <path
                            d="M22.675 0H1.326C.594 0 0 .594 0 1.326v21.348C0 23.406.594 24 1.326 24h11.495V14.708H9.692v-3.62h3.129V8.413c0-3.1 1.893-4.788 4.658-4.788 1.325 0 2.464.099 2.797.143v3.243l-1.92.001c-1.506 0-1.797.717-1.797 1.768v2.316h3.587l-.467 3.62h-3.12V24h6.116C23.406 24 24 23.406 24 22.674V1.326C24 .594 23.406 0 22.675 0Z" />
                    </svg>
                </a>
                <!-- Instagram -->
                <a href="#" target="_blank" class="text-gray-400 hover:text-white transition-colors duration-300">
