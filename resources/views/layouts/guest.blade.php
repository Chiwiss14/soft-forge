...
<body class="bg-gray-100 text-gray-800">
    ...
    <footer class="bg-black shadow-inner rounded-t-lg py-6 mt-10 text-gray-600">
        <div class="container mx-auto px-4">
            <!-- Top Section: Titles side by side -->
            <div class="flex justify-center gap-12 mb-6">
                <!-- Services -->
                <div class="flex flex-col items-center">
                    <span class="font-semibold mb-2">Services</span>
                    <div class="flex gap-3">
                        <!-- YouTube -->
                        <a href="#" target="_blank">
                            <svg class="w-6 h-6 text-grey-600" fill="currentColor" viewBox="0 0 24 24">
                                <path
                ...
                <!-- Carriers -->
                <div class="flex flex-col items-center">
                    <span class="font-semibold mb-2">Carriers</span>
                    <div class="flex gap-3">
                        <!-- Gmail -->
                        <a href="mailto:someone@example.com">
                            <svg class="w-6 h-6 text-grey-500" fill="currentColor" viewBox="0 0 24 24">
                                <path
                ...
                <div class="flex flex-col items-center">
                    ...
                    <div class="flex gap-3">
                        ...
                        <!-- X (Twitter) -->
                        <a href="#" target="_blank">
                            <svg class="w-6 h-6 text-grey" fill="currentColor" viewBox="0 0 24 24">
                                <path
            ...
            <!-- Bottom Section -->
            <p class="text-center text-sm text-gray-500">&copy; 2025 My App. All rights reserved.</p>
        </div>
    </footer>
